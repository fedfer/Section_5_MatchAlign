...
We now estimate a Bayesian factor model using the MSGP prior, with with $k = 25$ latent variables. To avoid running the full sampler, we recommend reading the file *out.rds* that contains the output of the function *linearMGSP_NA* with $k= 25$. 
