...
In this application, we use data from the National Health and Nutrition
Examination Survey (NHANES) collected in 2015 and 2016. We select a
subset of $107$ chemical exposures for which at least $30\%$ of
...
After pre-processing the data, more than $35\%$ of the observations are
still missing.
...
noticed that the first $25$ eigenvectors explain more than $65\%$ of the
total variability; hence, we set the number of factors equal to $k=25$.
...
$$ \frac{ || \overline{\Lambda\Lambda^T} - \bar \Lambda_* \bar \Lambda_* ^T ||_F }{|| \bar \Lambda_* \bar \Lambda_* ^T ||_F} $$
